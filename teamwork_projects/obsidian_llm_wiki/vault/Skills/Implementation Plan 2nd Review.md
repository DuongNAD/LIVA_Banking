...
> **Context:** A principal-architecture review has proposed changes, additions, and full-stack requirements against the current repository rules and vault architecture.
...
> 3. **Full-Stack Validation:** Double-check the proposal across the current Rust/Tauri, Vue, voice, mobile, and persistence layers. Ensure the data flow between workspace layers is secure and performant.
